...
('NV002', N'Huỳnh Thị Hồng Ân', '2005-10-30', N'Nữ', N'TP HCM', '0123456790', '4901103006@student.hcmue.edu.vn'),
('NV003', N'Võ Nhật Song Hân', '2005-03-29', N'Nữ', N'TP HCM', '0123456791', '4901103025@student.hcmue.edu.vn'),
('NV004', N'Võ Ngọc Tuyết Nhung', '2005-11-11', N'Nữ', N'TP HCM', '0123456792', '4901103058@student.hcmue.edu.vn');
('NV005', N'Lê Thị Kim Loan', '2005-10-08', N'Nữ', N'TP HCM', '0123456793', '4901103045@student.hcmue.edu.vn');
GO

-- Chèn dữ liệu mẫu vào bảng Sach
INSERT INTO Sach (MaSach, TenSach, TacGia, NXB, TheLoai, MaNV, SoLuong) VALUES
('S001', N'Dế Mèn Phiêu Lưu Ký', N'Tô Hoài', '1941', N'Sử Thi', 'NV001', 10),
('S002', N'Chí Phèo', N'Nam Cao', '1955', N'Truyện Ngắn', 'NV002', 15),
('S003', N'Vợ Nhặt', N'Kim Lân', '1955', N'Truyện Ngắn', 'NV003', 20);
('S004', N'Đất rừng phương Nam', N'Đoàn Giỏi', '1957', N'Tiểu Thuyết', 'NV004', 8);
('S005', N'Truyện Kiều', N'Nguyễn Du', '1820', N'Thơ', 'NV005', 17);
GO
...
('DV005', N'Bán', 'S004', 40000),
('DV006', N'Thuê', 'S004', 18000);
('DV005', N'Bán', 'S005', 25000),
('DV006', N'Thuê', 'S005', 10000);
GO
